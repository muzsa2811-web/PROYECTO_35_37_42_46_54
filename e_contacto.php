...
<script src="confirmarbcontacto.js"></script>
<body>
<div class="contenedor contenedorcon">
...
?>
			...
			<div class="filas"><a href="actualizarcontacto.php?id=<?php echo $mostrar['nombre'];?>">actualizar</a>||
		    <a href="procesareliminar_con.php?id=<?php echo $mostrar['nombre'];?> " class="eliminar">eliminar</a></div>
